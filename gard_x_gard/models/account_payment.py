...
class AccountPayment(models.Model):
    ...
    def write(self, vals):
        ...
        acc_pay_req_write = request.params.get('model') in ('account.payment.request') and request.params.get('method') in ('write')
        ...
        allow_write = move_reconcile or (group_cashier and calculate_cash) or cancel or action_draft or process_reconciliations or group_account_edit or acc_pay_req_write
