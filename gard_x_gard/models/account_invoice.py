...
class AccountInvoice(models.Model):
    ...
    def write(self, vals):
        ...
        allow_write = action_validate_invoice_payment or action_invoice_open or invoice_refund or move_reconcile or post or cancel or action_draft or group_account_edit
