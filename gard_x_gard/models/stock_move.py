...
#     is_accountable = fields.Boolean(
#         'Accountable',
#         compute='_compute_is_accountable',
#         copy=False,
#         store=True,
#         readonly=True,
#     )
...
#     ], string='Type', compute='_compute_move_type', store=True, readonly=True,
#         help="* In: Incoming stock.\n"
#              "* Out: Outgoing stock.\n"
#              "* Dropship: Dropshipped.\n"
#              "* Dropship: Returned dropship.\n"
...
#     def _is_internal(self):
#         return self.location_id._should_be_valued() and self.location_dest_id._should_be_valued()
...
#             '_is_in': 'is_in',
#             '_is_out': 'is_out',
#             '_is_dropshipped': 'is_dropshipped',
#             '_is_dropshipped_returned': 'is_dropshipped_returned',
#             '_is_internal': 'is_internal',
#         }
#         for move in self:
#             move_type = next((move_type for method, move_type in move_types.items() if getattr(move, method)()), None)
#             move.move_type = move_type[1:] if move_type else False

#     @api.depends('state', 'move_type')
#     def _compute_is_accountable(self):
#         for move in self:
#             move.is_accountable = bool(move.move_type and move.move_type != 'is_internal')
